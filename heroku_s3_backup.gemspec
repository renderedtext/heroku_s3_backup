...
Gem::Specification.new do |s|
  ...
  s.date = %q{2010-08-24}
  s.description = %q{http://almosteffortless.com/2010/04/14/automated-heroku-backups/ My fork replaces right_aws/aws-s3 with the fog gem}
  ...
  s.summary = %q{Gem to backup your database on Heroku.com to S3. Fork uses the fog gem}
  s.test_files = [
    "test/helper.rb",
     "test/test_heroku_s3_backup.rb"
  ]
